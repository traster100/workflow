...
$b->PddToken = '123';
$b->Authorization = '123';
$b->registrant_adddomain('tratata.ru');
$b->registrant_dellalldns('tratata.ru');
$b->registrar_adddns('tratata.ru', array('type' => 'A', 'content' => '127.0.0.2'));