...
/*
 * зайти на /vkchatbot/login.php
 * скопировать токен с адресной строки и вставить сюда в $params
 * проверить тут /vkchatbot/index.php
 *
...
// мессаги от самого бота
    if ($message->from_id == 123) {
        return false;
    }

    if ($message->read_state == 1 and $message->out == 1 and $message->from_id != 123) {
        return false;
    }

    $file = '/var/www/hayal/data/www/lsmodel.ru/vkchatbot/log.txt';
