...
//курл. скачивание страницы. $head=0 без заголовков севера, $head=1 с заголовками сервера; $body=0 без тела страницы, $body=1 с телом страницы; $verbose=0 молчаливый, $verbose=1 подробный вывод о действиях
