...
Общая оценка по Lighthouse
Проверка наличия минификации CSS и JS
Проверка наличия неблокирующей загрузки CSS и JS
Проверка необходимости оптимизации веса картинок
Проверка наличия сжатия Gzip или Brotli
...
Проверка наличия и необходимости микроформатов
Проверка наличия robots.txt и sitemap.xml
Анализ достаточности количества текста на страницах
Анализ качества и тошноты текста
Анализ наличия семантического ядра в текстах
Проверка текста на уникальность
Проверка на отсутствие бана домена, санкций поисковых систем
Проверка наличия подключенных систем аналитики
Проверка наличия указания региона продвижения
...
По главному запросу анализ топ-3 конкурентов
