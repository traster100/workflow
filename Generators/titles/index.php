...
# php /home/u/phpDev/SEOproject/scripts/registrators/titles_name_generator/title_name_generator.php
...
class Gettitle {
    ...
    public function title_gen($theme_id, $lang) { # тематика, язык
        if($lang == 2) {
            exit('Не доделан блок генератора названий блогов для англ. языка') . N;
        }
