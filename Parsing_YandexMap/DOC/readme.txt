...
C:/YD/soft/OpenServer/modules/php/PHP-5.6/php.exe C:/YD/domains/test.loc/yandex_map_parsing/index.php

==============================================================================================

mysqldump -u mysql -p map | "C:\Program Files\WinRAR\WinRAR.exe" > C:\dump.sql.gz
mysqldump -u mysql -p map > C:\dump.sql
18:48:58
все города и бренды объектов выбраны
